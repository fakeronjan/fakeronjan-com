(function () {
  ...
  var titleOddsTitle = "Probability of winning the NBA Finals, given (Rating, Offense, Defense, season progress, current playoff series state if applicable) through this point in the season. Trained on the same point in every other season (modern era only). League-wide probabilities sum to 100%.";
