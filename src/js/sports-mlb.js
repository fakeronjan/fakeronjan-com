(function () {
  ...
  var titleOddsTitle = "Probability of winning the World Series, from simulating the rest of the regular season and the postseason with current ratings. League-wide probabilities sum to 100%.";
  ...
  var poNav = document.getElementById("mlbPoNav");
  ...
  function renderPlayoffOdds() {
    ...
    var nR = short.length;
    poTitle.textContent = d.season + " MLB Postseason 🏆 Win Probability";
    ...
    var rows = ordered.map(function (t) {
      ...
      return "<tr>" +
        (d.hide_seed ? "" : '<td class="col-rank">' + t.seed + "</td>") + teamTd +
    ...
    poWrap.innerHTML =
      ...
      (d.hide_seed ? "" : '<th style="text-align:center;width:56px">Seed</th>') + '<th style="width:152px">Team</th>' +
      '<th class="col-od" style="width:60px">Rating</th>' +
      '<th class="col-hide-mobile col-od" style="width:56px">BAT</th>' +
      '<th class="col-hide-mobile col-od" style="width:56px">PIT</th>' +
      "<th>Results</th>" + heads +
      "</tr></thead><tbody>" + rows + "</tbody></table>";
    attachLinks(poWrap);
  }
